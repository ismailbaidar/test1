        ...
        <div class="mb-3">
          ...
          <div class="row mb-5 ">
            <div class="col-6">
                ...
                <label id="ll"  for="cinrecto"><i  style="font-size:220"  class="fa-solid fa-cloud-arrow-up"></i></label>
                </div>
            ...
            <div class="col-6">
                ...
                <div  style="border: 3px dashed #646161d6;border-radius:5px" >
                <label id="ll" for="cinverso"><i  style="font-size: 220" class="fa-solid fa-cloud-arrow-up"></i></label>
                </div>
